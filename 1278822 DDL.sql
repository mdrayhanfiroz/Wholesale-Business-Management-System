...
Table of Contents: DDL
			=> SECTION 01: Created a Database [WBMS]
...
IF DB_ID('WBMS') IS NOT NULL
DROP DATABASE WBMS
GO

CREATE DATABASE WBMS
ON
(
	name= 'wbms_data',
	filename = 'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER01\MSSQL\DATA\wbms_data.mdf',
	size = 5MB,
	maxsize = 50MB,
	filegrowth = 5%
)
...
(
	name = 'wbms_log',
	filename = 'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER01\MSSQL\DATA\wbms_log.ldf',
	size = 8MB,
	maxsize = 40MB,
	filegrowth = 5MB
)
...
BEGIN
	...
	ELSE
	BEGIN
		PRINT 'An Error Occured while inserting Data into the product Table !'
	END
